...
class GeminiQuickChat(commands.Cog):
    ...
    @commands.slash_command(
        description="Ask Jakey any quick question"
    )
    ...
    async def on_application_command_error(self, ctx: discord.ApplicationContext, error: discord.DiscordException):
        ...
        if isinstance(_error, commands.CommandOnCooldown):
            ...
            await ctx.respond(f"❌ Sorry, I couldn't answer your question at the moment, please try again later or change another model.\n**Error:** `{type(_error).__name__}`")
